...
public class HierClusterParams {
    ...
    public HierClusterParams withFeatureSetSuffix(String featureSetSuffix) {
        this.featureSetSuffix = featureSetSuffix;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((((("HierClusterParams"+" [matrixRef=")+ matrixRef)+", workspaceName=")+ workspaceName)+", featureSetSuffix=")+ featureSetSuffix)+", distThreshold=")+ distThreshold)+", distMetric=")+ distMetric)+", linkageMethod=")+ linkageMethod)+", fclusterCriterion=")+ fclusterCriterion)+", additionalProperties=")+ additionalProperties)+"]");
    }
