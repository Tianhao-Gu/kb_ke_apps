...
public class HierClusterOutput {
    ...
    public HierClusterOutput withClusterSetRefs(List<String> clusterSetRefs) {
        this.clusterSetRefs = clusterSetRefs;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((("HierClusterOutput"+" [clusterSetRefs=")+ clusterSetRefs)+", reportName=")+ reportName)+", reportRef=")+ reportRef)+", additionalProperties=")+ additionalProperties)+"]");
    }
