...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_ke_apps'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_ke_apps.kb_ke_appsImpl import kb_ke_apps  # noqa @IgnorePep8
impl_kb_ke_apps = kb_ke_apps(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_ke_apps'
